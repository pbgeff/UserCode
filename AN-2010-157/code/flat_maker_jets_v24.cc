...
int flat_maker(){
  ...
  //Data
  //chainB->Add("/data01/cfA/JetMETTauMonitor_Run2010A-PromptReco-v1_RECO_UCSB0210_v24/cfA*.root/configurableAnalysis/eventB");
  //chainV->Add("/data01/cfA/JetMETTauMonitor_Run2010A-PromptReco-v1_RECO_UCSB0210_v24/cfA*.root/configurableAnalysis/eventV");
  //output_filename="CMS_jet_monitor_data.root";
/*
  chainB->Add("/data01/cfA/MinimumBias_Commissioning10-SD_JetMETTau-v9_RECO_UCSB0208_v24/cfA*.root/configurableAnalysis/eventB");
  chainV->Add("/data01/cfA/MinimumBias_Commissioning10-SD_JetMETTau-v9_RECO_UCSB0208_v24/cfA*.root/configurableAnalysis/eventV");
  int MC_flag = 0;
  ...
  for(int ia = 0; ia<nentries; ia++){ 
   ...
   //Trigger Bits
    ...
    for (unsigned int k=0; k<jets_AK5_pt->size(); k++) {
      if(jets_AK5_et->at(k)<40/*10*/) continue;
